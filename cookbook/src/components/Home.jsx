...
const Home = (props) => {
  return (
    <div className="Home">
      ...
      <>
        <Link to="/recipes/quick"><h3 className="categoriesHome">Quick</h3>
          <img
            className="home-pic"
        ...
        <Link to="/recipes/casual"><h3 className="categoriesHome">Casual</h3>
          <img
            className="home-pic"
        ...
        <Link to="/recipes/group"><h3 className="categoriesHome">Group</h3>
          <img
            className="home-pic"
